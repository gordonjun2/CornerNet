...
from db.detection_video import DETECTION
...
class MSCOCO(DETECTION):
    def __init__(self):#, db_config, split):
        #super(MSCOCO, self).__init__(self)
        ...
        self._cache_file = os.path.join(cache_dir, "coco_{}.pkl".format("test"))
        #self._load_data()
